...
geomSpace(activecon, gate, 3.5*LAMBDA - EPSILON, 0, '6.4 Diffusion contact spacing to gate of transistor >= 0.035'); addErrors()
...
geomEnclose(metal2, via12, 3*LAMBDA - EPSILON, '14.3.1 M2 enclosed VIA12 two opisite sides >= 0.030'); addErrors()
