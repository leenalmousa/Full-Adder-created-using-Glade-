...
geomSpace(poly, 9*LAMBDA - EPSILON, 0, '3.2 Poly spacing >= 0.09'); addErrors()
geomNotch(poly, 9*LAMBDA - EPSILON, '3.2 Poly spacing >= 0.09'); addErrors()
geomExtension(poly, active, 8*LAMBDA - EPSILON, '3.3 Poly extension of diffusion >= 0.08'); addErrors()
geomExtension(active, poly, 7.5*LAMBDA - EPSILON, '3.4 Diffusion extension of poly >= 0.075'); addErrors()
...
geomEnclose(active, activecon, 0.5*LAMBDA - EPSILON, abut, '6.2 Diffusion enclosed contact all sides >= 0.015, or >= 0.005 for one side with other 2 sides >= 0.02'); addErrors()
...
geomSpace(activecon, gate, 1*LAMBDA - EPSILON, 0, '6.4 Diffusion contact spacing to gate of transistor >= 0.01'); addErrors()

print 'Checking M1 rules...'
geomWidth(metal1, 6*LAMBDA - EPSILON, '7.1 M1 width >= 0.06'); addErrors()
...
geomEnclose(metal1, contact, 1*LAMBDA - EPSILON, abut, '7.3 M1 enclosed contact all sides >= 0.015, or >= 0.005 for parallel sides with other 2 sides >= 0.03'); addErrors()
geomEnclose2(metal1, contact, 1.5*LAMBDA, 0.5*LAMBDA, 3*LAMBDA, 2, '7.3 M1 enclosed contact all sides >= 0.015, or >= 0.005 for parallel sides with other 2 sides >= 0.03'); addErrors()
...
geomArea(via12, (4*LAMBDA - EPSILON)**2, (4*LAMBDA + EPSILON)**2, '8.1 Exact VIA12 size = 0.04 x 0.04'); addErrors()
...
geomEnclose(metal1, via12, 0.5*LAMBDA - EPSILON, '8.3 M1 overlap of via12 >= 0.005'); addErrors()

print 'Checking M2 rules...'
geomWidth(metal2, 6*LAMBDA - EPSILON, '9.1 M2 width >= 0.06'); addErrors()
...
geomEnclose(metal2, via12, LAMBDA - EPSILON, abut, '9.3 M2 enclosed VIA12 all sides >= 0.015, or >= 0.005 for parallel sides with other 2 sides >= 0.03'); addErrors()
geomEnclose2(metal2, via12, 1.5*LAMBDA, 0.5*LAMBDA, 3*LAMBDA, 2, '9.3 M2 enclosed VIA12 all sides >= 0.015, or >= 0.005 for parallel sides with other 2 sides >= 0.03'); addErrors()
